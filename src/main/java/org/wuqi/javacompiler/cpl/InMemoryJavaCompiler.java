package org.wuqi.javacompiler.cpl;
...
public class InMemoryJavaCompiler {
	...
	private static InMemoryJavaCompiler INSTANCE;

	public static InMemoryJavaCompiler newInstance(ClassLoader parent) {
		if (null != INSTANCE){
			return INSTANCE;
		}
		synchronized (InMemoryJavaCompiler.class){
			if (null != INSTANCE){
				return INSTANCE;
			}
			if (parent == null){
				...
				INSTANCE =  new InMemoryJavaCompiler();
				INSTANCE.useParentClassLoader(parent);
			}
		}
		return INSTANCE;
	}
